					...
					<table id="myTable" class="table">
						...
						<tbody>
							<c:forEach items="${prodlist}" var="c">
								<tr>
								    <td><img src="resources/productimage/${c.productId}.jpg" width="75" height="75"/></td>
									<td>${c.productId}</td>
									<td>${c.productName}</td>
									<td>${c.productDesc}</td>
									<td>${c.price}</td>
